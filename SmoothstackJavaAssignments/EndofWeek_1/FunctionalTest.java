...
public class FunctionalTest {
	...
	@Test
	public void noXTest() {
		assertEquals(new ArrayList<>(Arrays.asList("[a]","[b]","[]")),Functional.noX(new ArrayList<String>(Arrays.asList("ax", "bx", "x"))));
		assertEquals(new ArrayList<>(Arrays.asList("[y]","[b]","[]")),Functional.noX(new ArrayList<String>(Arrays.asList("xy", "bx", "x"))));
		assertNotEquals(new ArrayList<>(Arrays.asList("[x]","[x]","[x]")),Functional.noX(new ArrayList<String>(Arrays.asList("x", "x", "x"))));
	}
